<?php
// Definir canciones y sus archivos de registro
$songs = [
    'ADOBE - LODO CLANDESTINO' => [
        'filePath' => 'assets/mp3/ADOBE - LODO CLANDESTINO.mp3',
        'counterFile' => '00.txt'
    ],
    'ESTARE CERCA' => [
        'filePath' => 'assets/mp3/ESTARÉ CERCA  ADOBE ft DEIVI.mp3',
        'counterFile' => '01.txt'
    ]
];

// Obtener el parámetro de la canción desde la URL
$songKey = $_GET['song'] ?? '';

// Verificar si la canción existe en el arreglo
if (array_key_exists($songKey, $songs)) {
    $filePath = $songs[$songKey]['filePath'];
    $counterFile = $songs[$songKey]['counterFile'];
    ...
    // Si la canción no está en el arreglo
    http_response_code(400);
    echo "Canción no especificada o no válida.";
}
?>
